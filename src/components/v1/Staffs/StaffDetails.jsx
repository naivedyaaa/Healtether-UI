...
export default function StaffDetails() {
    ...
    const [nameValue,setNameValue]=useState("Dr. Kim Jones");
    const [specializationValue,setSpecializationValue]=useState("MBBS,DLO,MS(ENT)");
    const [roleValue,setRoleValue]=useState("ENT specialist");
    ...
    const [otherDocumentValue,setOtherDocumentValue]=useState("1. Aadhar card.png");
    ...
    const [addressValue,setAddressValue]=useState("Plot No. 4-75/1, Madhavi Nagar, Opposite BHEL R(&)D Gate, BalaNagar Hyderabad, Telangana, 500037.");
        ...
        <div className="md:flex flex-wrap font-['arimo'] mt-5 lg:divide-x">
            ...
            <div className="text-base font-semibold tracking-wider mt-4 text-black "> DOCUMENTS
            <div className="lg:w-20 xs:w-12 h-1 bg-[#009394] "></div>
                    </div>
