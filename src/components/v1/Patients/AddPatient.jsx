  ...
  return (
    ...
    <div className="text-base font-semibold tracking-wider">PERSONAL DETAILS
            ...
            <div className="w-3/4 justify-start flex flex-col mt-2">
                    <button className="bg-gray-800 text-white mt-2 flex justify-between items-center p-2 rounded-md"onClick={()=>medicalRecordsRef.current.click()}>Browse to upload documents <i className="icon-[bytesize--upload] text-2xl "></i> </button>
    ...
    <div className="lg:w-20 xs:w-12 h-1 bg-[#009394] "></div>
            ...
            <div className="flex flex-col mt-2">
                ...
                <div className="w-3/4 justify-start flex flex-col">
                    <button className="bg-gray-800 text-white mt-2 flex justify-between items-center p-2 rounded-md"onClick={()=>docUploadRef.current.click()}>Browse to upload documents <i className="icon-[bytesize--upload] text-2xl "></i> </button>
            ...
            <div className="w-3/4 justify-start flex flex-col mt-2">
                    <button className="bg-gray-800 text-white mt-2 flex justify-between items-center p-2 rounded-md"onClick={()=>procedureRecordsRef.current.click()}>Browse to upload documents <i className="icon-[bytesize--upload] text-2xl "></i> </button>
